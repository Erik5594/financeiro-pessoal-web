...
export const listar = createAsyncThunk('despesa/listar',async (data, { rejectWithValue }) => {
...
export const cadastrar = createAsyncThunk('despesa/cadastrar',async (data, { rejectWithValue }) => {
	try {
		const response = await DespesaService.cadastrar(data)
        return response
	} catch (err) {
		return rejectWithValue(err.response?.data?.message || 'Error')
	}
...
export const excluir = createAsyncThunk('despesa/excluir',async (data, { rejectWithValue }) => {
	try {
